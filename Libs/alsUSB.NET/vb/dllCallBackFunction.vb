...
Module dllCallBackFunction
    ...
    Public gUsb As cUsb2I2c 'JWG Object
	...
	Public Function attachCallback(ByVal hDevice As Integer) As Boolean
        ...
        ' JWG m_pUserData.dwAttachError = WDU_SetInterface(m_pUserData.hDev, m_pUserData.dwInterfaceNum, m_pUserData.dwAlternateSetting)
