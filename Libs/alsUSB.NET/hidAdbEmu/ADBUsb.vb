...
Friend Class ADBUsb
    ...
    Public Function DllCallBack(ByVal RW As Integer, ByVal addr As Integer, ByRef data As Integer) As Integer
        ...
        If gNoUsb = False Then
            Select Case (RW)
                Case 0 : Call modHIDusb.i2cWrite(baddr, data)
                Case 1 : data = modHIDusb.i2cRead(baddr)
                Case 2 : Call modHIDusb.i2cWriteWord(baddr, data)
                Case 3 : data = modHIDusb.i2cReadWord(baddr)
                Case 4 : i2cAddr = addr
                Case 5 : data = i2cAddr
            End Select
