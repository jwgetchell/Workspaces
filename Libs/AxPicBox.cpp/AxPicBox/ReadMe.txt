========================================================================
    ACTIVEX CONTROL DLL : AxPicBox Project Overview
========================================================================

ControlWizard has created this project for your AxPicBox ActiveX Control
...
that make up your AxPicBox ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
CAxPicBoxCtrl control:

AxPicBoxCtrl.h
    This file contains the declaration of the CAxPicBoxCtrl C++ class.

AxPicBoxCtrl.cpp
    This file contains the implementation of the CAxPicBoxCtrl C++ class.

AxPicBoxPropPage.h
    This file contains the declaration of the CAxPicBoxPropPage C++ class.

AxPicBoxPropPage.cpp
    This file contains the implementation of the CAxPicBoxPropPage C++ class.

CAxPicBoxCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CAxPicBoxCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file AxPicBox.rc.
...
stdafx.h, stdafx.cpp
    ...
    named AxPicBox.pch and a precompiled types (PCT) file named stdafx.obj.
