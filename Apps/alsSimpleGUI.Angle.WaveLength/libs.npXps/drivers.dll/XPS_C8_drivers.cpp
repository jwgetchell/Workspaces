...
{ 
	...
	/* Convert to string */ 
	sprintf (ExecuteMethod, "PositionerDACOffsetSet (%s,%hd,%hd)", PositionerName, DACOffset1, DACOffset2);
...
{ 
	...
	/* Convert to string */ 
	sprintf (ExecuteMethod, "PositionerDACOffsetDualSet (%s,%hd,%hd,%hd,%hd)", PositionerName, PrimaryDACOffset1, PrimaryDACOffset2, SecondaryDACOffset1, SecondaryDACOffset2);
