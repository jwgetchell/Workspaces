...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame fmRegisters 
      ...
      Begin VB.ComboBox cmbIO 
         Height          =   315
         Index           =   0
         ItemData        =   "frmMain.dll.frx":0CD0
         Left            =   120
         List            =   "frmMain.dll.frx":0CEC
         TabIndex        =   81
         Text            =   "0"
         Top             =   720
         Width           =   615
      ...
      Begin VB.ComboBox cmbIO 
         Height          =   315
         Index           =   1
         ItemData        =   "frmMain.dll.frx":0D08
         Left            =   720
         List            =   "frmMain.dll.frx":0D24
         TabIndex        =   80
         Text            =   "FF"
         Top             =   720
         Width           =   615
      ...
      Begin VB.Frame frmDataStats 
         ...
         Begin VB.Frame fnSweep 
            ...
            Begin VB.ComboBox cmbSweep 
               Height          =   315
               ItemData        =   "frmMain.dll.frx":0D4A
               Left            =   120
               List            =   "frmMain.dll.frx":0D5D
               TabIndex        =   19
               Text            =   "nm"
               Top             =   240
               Width           =   1095
