...
Module windrvr
    ...
    ' JWG	Declare Function DeviceIoControl Lib "kernel32" (ByVal hDevice As Integer, ByVal dwIoControlCode As Integer, ByRef lpInBuffer As Any, ByVal nInBufferSize As Integer, ByRef lpOutBuffer As Integer, ByVal nOutBufferSize As Integer, ByRef lpBytesReturned As Integer, ByVal lpOverlapped As Integer) As Integer
	...
	'UPGRADE_ISSUE: Declaring a parameter 'As Any' is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="FAE78A8D-8978-4FD4-8208-5B7324A8F795"'
    ' JWG	Declare Function WD_VB_GetAddress Lib "kernel32"  Alias "MulDiv"(ByRef dwNum As Any, ByVal one As Integer, ByVal one_ As Integer) As Integer
	...
	Function WD_Debug_Renamed(ByVal hWD As Integer, ByRef Debug_parm As WD_Debug) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_DEBUG, Debug_parm, ucALSusb.LenB(Debug_parm), WD_Debug, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_DebugDump(ByVal hWD As Integer, ByRef DebugDump As WD_DEBUG_DUMP) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_DEBUG_DUMP, DebugDump, ucALSusb.LenB(DebugDump), WD_DebugDump, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_Transfer_Renamed(ByVal hWD As Integer, ByRef Transfer As WD_Transfer) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_TRANSFER, Transfer, ucALSusb.LenB(Transfer), WD_Transfer, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_MultiTransfer(ByVal hWD As Integer, ByRef TransferArray As WD_Transfer, ByVal dwNumTransfers As Short) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_MULTI_TRANSFER, TransferArray, ucALSusb.LenB(TransferArray) * dwNumTransfers, WD_MultiTransfer, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_DMALock(ByVal hWD As Integer, ByRef Dma As WD_DMA) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_DMA_LOCK, Dma, ucALSusb.LenB(Dma), WD_DMALock, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_DMAUnlock(ByVal hWD As Integer, ByRef Dma As WD_DMA) As Object
        ...
        'UPGRADE_ISSUE: ucALSusb.LenB function is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="367764E5-F3F8-4E43-AC3E-7FE0B5E074E2"'
        'UPGRADE_WARNING: Couldn't resolve default property of object Dma. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_DMA_UNLOCK, Dma, ucALSusb.LenB(Dma), WD_DMAUnlock, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_IntEnable(ByVal hWD As Integer, ByRef TheInterrupt As WD_INTERRUPT) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_INT_ENABLE, TheInterrupt, ucALSusb.LenB(TheInterrupt), WD_IntEnable, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_IntDisable(ByVal hWD As Integer, ByRef TheInterrupt As WD_INTERRUPT) As Object
        ...
        'UPGRADE_ISSUE: ucALSusb.LenB function is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="367764E5-F3F8-4E43-AC3E-7FE0B5E074E2"'
        'UPGRADE_WARNING: Couldn't resolve default property of object TheInterrupt. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_INT_DISABLE, TheInterrupt, ucALSusb.LenB(TheInterrupt), WD_IntDisable, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_IntCount(ByVal hWD As Integer, ByRef TheInterrupt As WD_INTERRUPT) As Object
        ...
        'UPGRADE_ISSUE: ucALSusb.LenB function is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="367764E5-F3F8-4E43-AC3E-7FE0B5E074E2"'
        'UPGRADE_WARNING: Couldn't resolve default property of object TheInterrupt. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_INT_COUNT, TheInterrupt, ucALSusb.LenB(TheInterrupt), WD_IntCount, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_IntWait(ByVal hWD As Integer, ByRef TheInterrupt As WD_INTERRUPT) As Object
        ...
        'UPGRADE_ISSUE: ucALSusb.LenB function is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="367764E5-F3F8-4E43-AC3E-7FE0B5E074E2"'
        'UPGRADE_WARNING: Couldn't resolve default property of object TheInterrupt. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        ' JWG        DeviceIoControl(h, IOCTL_WD_INT_WAIT, TheInterrupt, ucALSusb.LenB(TheInterrupt), WD_IntWait, 4, WinDriverGlobalDW, 0)
        WD_Close(h)
    ...
    Function WD_IsapnpScanCards(ByVal hWD As Integer, ByRef IsapnpScanCards As WD_ISAPNP_SCAN_CARDS) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_ISAPNP_SCAN_CARDS, IsapnpScanCards, ucALSusb.LenB(IsapnpScanCards), WD_IsapnpScanCards, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_IsapnpGetCardInfo(ByVal hWD As Integer, ByRef IsapnpGetCardInfo As WD_ISAPNP_CARD_INFO) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_ISAPNP_GET_CARD_INFO, IsapnpGetCardInfo, ucALSusb.LenB(IsapnpGetCardInfo), WD_IsapnpGetCardInfo, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_IsapnpConfigDump(ByVal hWD As Integer, ByRef IsapnpConfigDump As WD_ISAPNP_CONFIG_DUMP) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_ISAPNP_CONFIG_DUMP, IsapnpConfigDump, ucALSusb.LenB(IsapnpConfigDump), WD_IsapnpConfigDump, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_PcmciaScanCards(ByVal hWD As Integer, ByRef PcmciaScanCards As WD_PCMCIA_SCAN_CARDS) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_PCMCIA_SCAN_CARDS, PcmciaScanCards, ucALSusb.LenB(PcmciaScanCards), WD_PcmciaScanCards, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_PcmciaGetCardInfo(ByVal hWD As Integer, ByRef PcmciaCardInfo As WD_PCMCIA_CARD_INFO) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_PCMCIA_GET_CARD_INFO, PcmciaCardInfo, ucALSusb.LenB(PcmciaCardInfo), WD_PcmciaGetCardInfo, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_PcmciaConfigDump(ByVal hWD As Integer, ByRef PcmciaConfigDump As WD_PCMCIA_CONFIG_DUMP) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_PCMCIA_CONFIG_DUMP, PcmciaConfigDump, ucALSusb.LenB(PcmciaConfigDump), WD_PcmciaConfigDump, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_Sleep_Renamed(ByVal hWD As Integer, ByRef Sleep As WD_Sleep) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_SLEEP, Sleep, ucALSusb.LenB(Sleep), WD_Sleep, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_CardRegister(ByVal hWD As Integer, ByRef Card As WD_CARD_REGISTER) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_CARD_REGISTER, Card, ucALSusb.LenB(Card), WD_CardRegister, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_CardUnregister(ByVal hWD As Integer, ByRef Card As WD_CARD_REGISTER) As Object
        ...
        'UPGRADE_ISSUE: ucALSusb.LenB function is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="367764E5-F3F8-4E43-AC3E-7FE0B5E074E2"'
        'UPGRADE_WARNING: Couldn't resolve default property of object Card. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_CARD_UNREGISTER, Card, ucALSusb.LenB(Card), WD_CardUnregister, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_PciScanCards(ByVal hWD As Integer, ByRef pciScan As WD_PCI_SCAN_CARDS) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_PCI_SCAN_CARDS, pciScan, ucALSusb.LenB(pciScan), WD_PciScanCards, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_PciGetCardInfo(ByVal hWD As Integer, ByRef PciCard As WD_PCI_CARD_INFO) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_PCI_GET_CARD_INFO, PciCard, ucALSusb.LenB(PciCard), WD_PciGetCardInfo, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_Version_Renamed(ByVal hWD As Integer, ByRef VerInfo As WD_Version) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_VERSION, VerInfo, ucALSusb.LenB(VerInfo), WD_Version, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_License_Renamed(ByVal hWD As Integer, ByRef License As WD_License) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_LICENSE, License, ucALSusb.LenB(License), WD_License, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_KernelPlugInOpen(ByVal hWD As Integer, ByRef KernelPlugInOpen As WD_KERNEL_PLUGIN) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_KERNEL_PLUGIN_OPEN, KernelPlugInOpen, ucALSusb.LenB(KernelPlugInOpen), WD_KernelPlugInOpen, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_KernelPlugInClose(ByVal hWD As Integer, ByRef KernelPlugInClose As WD_KERNEL_PLUGIN) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_KERNEL_PLUGIN_CLOSE, KernelPlugInClose, ucALSusb.LenB(KernelPlugInClose), WD_KernelPlugInClose, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_KernelPlugInCall(ByVal hWD As Integer, ByRef KernelPlugInCall As WD_KERNEL_PLUGIN_CALL) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_KERNEL_PLUGIN_CALL, KernelPlugInCall, ucALSusb.LenB(KernelPlugInCall), WD_KernelPlugInCall, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_PciConfigDump(ByVal hWD As Integer, ByRef PciConfigDump As WD_PCI_CONFIG_DUMP) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_PCI_CONFIG_DUMP, PciConfigDump, ucALSusb.LenB(PciConfigDump), WD_PciConfigDump, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_UsbScanDevice(ByVal hWD As Integer, ByRef Scan As WD_USB_SCAN_DEVICES) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_USB_SCAN_DEVICES, Scan, ucALSusb.LenB(Scan), WD_UsbScanDevice, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_UsbGetConfiguration(ByVal hWD As Integer, ByRef Config As WD_USB_CONFIGURATION) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_USB_GET_CONFIGURATION, Config, ucALSusb.LenB(Config), WD_UsbGetConfiguration, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_UsbDeviceRegister(ByVal hWD As Integer, ByRef Dev As WD_USB_DEVICE_REGISTER) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_USB_DEVICE_REGISTER, Dev, ucALSusb.LenB(Dev), WD_UsbDeviceRegister, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_UsbTransfer(ByVal hWD As Integer, ByRef Trans As WD_USB_TRANSFER) As Object
        ...
        ' JWG        DeviceIoControl(h, IOCTL_WD_USB_TRANSFER, Trans, ucALSusb.LenB(Trans), WD_UsbTransfer, 4, WinDriverGlobalDW, 0)
        WD_Close(h)
    ...
    Function WD_UsbDeviceUnregister(ByVal hWD As Integer, ByRef Dev As WD_USB_DEVICE_REGISTER) As Object
        ...
        'UPGRADE_ISSUE: ucALSusb.LenB function is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="367764E5-F3F8-4E43-AC3E-7FE0B5E074E2"'
        'UPGRADE_WARNING: Couldn't resolve default property of object Dev. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_USB_DEVICE_UNREGISTER, Dev, ucALSusb.LenB(Dev), WD_UsbDeviceUnregister, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_UsbResetPipe(ByVal hWD As Integer, ByRef ResetPipe As WD_USB_RESET_PIPE) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_USB_RESET_PIPE, ResetPipe, ucALSusb.LenB(ResetPipe), WD_UsbResetPipe, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_UsbResetDevice(ByVal hWD As Integer, ByVal hDev As Integer) As Object
        ...
        'UPGRADE_ISSUE: ucALSusb.LenB function is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="367764E5-F3F8-4E43-AC3E-7FE0B5E074E2"'
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_USB_RESET_DEVICE, hDev, ucALSusb.LenB(hDev), WD_UsbResetDevice, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_UsbResetDeviceEx(ByVal hWD As Integer, ByRef ResetDevice As WD_USB_RESET_DEVICE) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_USB_RESET_DEVICE_EX, ResetDevice, ucALSusb.LenB(ResetDevice), WD_UsbResetDeviceEx, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_EventRegister(ByVal hWD As Integer, ByRef wdEvent As WD_EVENT) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_EVENT_REGISTER, wdEvent, ucALSusb.LenB(wdEvent), WD_EventRegister, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_EventUnregister(ByVal hWD As Integer, ByRef wdEvent As WD_EVENT) As Object
        ...
        'UPGRADE_ISSUE: ucALSusb.LenB function is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="367764E5-F3F8-4E43-AC3E-7FE0B5E074E2"'
        'UPGRADE_WARNING: Couldn't resolve default property of object wdEvent. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_EVENT_UNREGISTER, wdEvent, ucALSusb.LenB(wdEvent), WD_EventUnregister, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_EventPull(ByVal hWD As Integer, ByRef wdEvent As WD_EVENT) As Object
        ...
        'UPGRADE_ISSUE: ucALSusb.LenB function is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="367764E5-F3F8-4E43-AC3E-7FE0B5E074E2"'
        'UPGRADE_WARNING: Couldn't resolve default property of object wdEvent. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_EVENT_PULL, wdEvent, ucALSusb.LenB(wdEvent), WD_EventPull, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_EventSend(ByVal hWD As Integer, ByRef wdEvent As WD_EVENT) As Object
        ...
        'UPGRADE_ISSUE: ucALSusb.LenB function is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="367764E5-F3F8-4E43-AC3E-7FE0B5E074E2"'
        'UPGRADE_WARNING: Couldn't resolve default property of object wdEvent. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_EVENT_SEND, wdEvent, ucALSusb.LenB(wdEvent), WD_EventSend, 4, WinDriverGlobalDW, 0)
    ...
    Function WD_DebugAdd(ByVal hWD As Integer, ByRef dbg As WD_DEBUG_ADD) As Object
        ...
        ' JWG        DeviceIoControl(hWD, IOCTL_WD_DEBUG_ADD, dbg, ucALSusb.LenB(dbg), WD_DebugAdd, 4, WinDriverGlobalDW, 0)
