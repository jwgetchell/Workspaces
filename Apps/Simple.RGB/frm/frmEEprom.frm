...
Private Sub cmdEEpromIO_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case eepromButtons.cmdReadHdw:
        
            EEprom.getEEprom Me
            
            If EEprom.getEEpromVersion = eePromRevs.E004 Then ' jwg temp kludge
                modHIDusb.setPageFragmentAddr True ' won't work for win8 bypass
            End If
