...
Public Class clsEEprom
    ...
    Public Sub setI2c(ByVal addrVal As Short) 'eePromAddrs)
    ...
    Public Sub setTBobj(ByRef widget As Object, Optional ByRef Index As Short = 0) 'TextBox, Optional Index As Integer = 0)
    ...
    Public Sub getEEprom(Optional ByRef cbFrm As Object = Nothing) '(Optional cbFrm As Form = Nothing)
        ...
        'UPGRADE_WARNING: Couldn't resolve default property of object cbFrm.setEEpromObjs. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        cbFrm.setEEpromObjs()
...
endSub: FileClose(1)
    ...
    Public Sub getFile(Optional ByRef file As String = defaultFile, Optional ByRef cbFrm As Object = Nothing) 'Form = Nothing)
