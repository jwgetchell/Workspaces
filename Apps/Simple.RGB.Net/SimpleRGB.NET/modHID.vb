...
Module modHID
	...
	Public Declare Function FormatMessage Lib "kernel32"  Alias "FormatMessageA"(ByVal dwFlags As Integer, ByRef lpSource As Any, ByVal dwMessageId As Integer, ByVal dwLanguageZId As Integer, ByVal lpBuffer As String, ByVal nSize As Integer, ByVal Arguments As Integer) As Integer
	...
	Public Declare Function HidD_GetHidGuid Lib "hid.dll" (ByRef HidGuid As GUID) As Integer
	...
	'UPGRADE_WARNING: Structure GUID may require marshalling attributes to be passed as an argument in this Declare statement. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="C429C3A5-5D47-4CD9-8F51-74A1616405DC"'
	Public Declare Function SetupDiEnumDeviceInterfaces Lib "setupapi.dll" (ByVal DeviceInfoSet As Integer, ByVal DeviceInfoData As Integer, ByRef InterfaceClassGuid As GUID, ByVal MemberIndex As Integer, ByRef DeviceInterfaceData As SP_DEVICE_INTERFACE_DATA) As Integer
	
	'UPGRADE_WARNING: Structure GUID may require marshalling attributes to be passed as an argument in this Declare statement. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="C429C3A5-5D47-4CD9-8F51-74A1616405DC"'
	Public Declare Function SetupDiGetClassDevs Lib "setupapi.dll"  Alias "SetupDiGetClassDevsA"(ByRef ClassGuid As GUID, ByVal Enumerator As String, ByVal hwndParent As Integer, ByVal Flags As Integer) As Integer
	...
	Public Sub Pause(ByRef SecsDelay As Single)
		...
		Do While PrevTimer < TimeOut
			dllCallBackFunction.Sleep(4) '-- Timer is only updated every 1/64 sec = 15.625 millisecs.
		...
		Do 
			...
			Do 
				...
				If api_status <> 0 Then
					...
					DevicePathName = System.Text.UnicodeEncoding.Unicode.GetString(DetailDataBuffer)
